...
export const SLIME_SHOP_CATALOG: readonly SlimeShopItem[] = [
  ...
  },
  {
    ...
    effectKey: "comment_reward",
    effectBps: 300,
    spritePath: `${SLIME_ASSET_ROOT}/shop/backgrounds/fizzy-soda-dream/aura-package/fizzy-soda-dream-6s-64.gif`,
    mobileSpritePath: `${SLIME_ASSET_ROOT}/shop/backgrounds/fizzy-soda-dream/aura-package/fizzy-soda-dream-6s-256.gif`,
    staticSpritePath: `${SLIME_ASSET_ROOT}/shop/backgrounds/fizzy-soda-dream/static-background-64.png`,
  },
  {

...
학생과 학부모가 웹과 같은 데이터·권한 계약을 사용하는 Expo 앱입니다. 휴대폰과 Galaxy Tab 계열 가로 화면을 모두 지원하며, 프로덕션 API는 `https://aura-board-app.vercel.app`을 사용합니다.
...
| 레이아웃 | 모바일 구현 |
|---|---|
| `freeform`, `grid`, `stream` | 카드 작성·첨부·상세·수정/삭제 |
| `columns` | 주제별 열 탐색과 카드 작성 |

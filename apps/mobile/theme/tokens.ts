...
/** Authoritative Omok board and active-game tokens. Kept here so the game
 * surface follows the shared rule against component-local visual constants.
 * A 15x15 grid cannot give each intersection a 44dp target at 360dp width, so
 * the board is a continuous aim surface and the confirm/cancel controls carry
 * the accessible targets; aim and pending markers stay distinct through ring,
 * dash and transparency rather than hue alone. */
export const omokTokens = {
  ...
  hudSurface: "#ffffff",
  hudBorder: "#c9ded8",
  myTurnSurface: "#7f66f0",
  myTurnText: "#f2fffb",
  peerTurnSurface: "#dcd6fa",
  peerTurnText: "#4d3d99",
  roomSurface: "#f6f5fe",
  timerTrack: "#ece9fa",
  timerFill: "#7f66f0",
  timerLetterSpacing: 1.2,
  timerTrackHeight: 8,
  timerHeadSize: 8,
  timerHeadBorderWidth: 2,
  turnBarMinHeight: 52,
  hudMinHeight: 44,
  hudStoneSize: 18,
  hudStoneBorderWidth: 1,
  turnBadgeSurface: "#dceee8",
  turnBadgeText: "#174f41",
  aimRing: "#0f5c8a",
  aimRingWidth: 3,
  aimFill: "rgba(15, 92, 138, 0.22)",
  aimCrosshairSize: 10,
  aimCrosshairStroke: 2,
  pendingOpacity: 0.62,
  pendingRing: "#0f5c8a",
  pendingRingWidth: 2,
  pendingCore: "#ffc847",
  ...
  boardMaxEdge: 520,
  boardMinEdge: 240,
  /** Room for HUD, turn bar, hint line and action row. */
  reservedHeight: 268,
  /** A terminal result card replaces the compact active-game action row. */
  terminalReservedHeight: 338,
  confirmMinHeight: 48,
  confirmGap: 12,
  terminalMaxWidth: 420,
  recoveryMinHeight: 44,
  recoveryReservedHeight: 60,
  recoveryButtonMinWidth: 88,
  noticeSurface: "#fffaf0",
  noticeBorder: "#ecd9ae",
  noticeText: "#6b5424",
} as const;
...
export const walking = {
  ...
  missionSlimeLayoutSize: 64,
  missionSlimeVisualSize: 32,
  missionSlimeFootOffset: 41,
  ...
  classroomRankRewardMutedOpacity: 0.76,
  classroomRankRewardClaimedOpacity: 0.52,
